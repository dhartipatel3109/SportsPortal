<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AssignEvent.aspx.cs" Inherits="GTU_Portal.AssignEvent" %>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Send Email" OnClick="AssignButton_Click" />
                            </div>
                        </div>
                        <div class="box-body table-responsive no-padding">
                            <br />
                            <asp:GridView ID="GridView1" CssClass="table table-bordered table-hover table-striped" runat="server" AutoGenerateColumns="False" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting" RowDataBound="GridView1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Assign_date" HeaderText="Final Date" SortExpression="Final Date" />
