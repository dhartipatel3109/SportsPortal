<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StudentRecord.aspx.cs" Inherits="GTU_Portal.WebForm14" %>
                ...
                <section class="col-lg-12">
                    <div class="box box-primary">
                        ...
                        <div id="PDF" runat="server">
                            ...
                            <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-condensed" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Egas_id" ShowHeaderWhenEmpty="True" OnDataBound="GridView1_DataBound">
                                <Columns>
                            ...
                            <div style="float: right">
                                <asp:Panel ID="Panel6" ScrollBars="Auto" runat="server" CssClass="modalPopup" Style="display: none; border: 5px solid gray; background-color: white" Width="70%" Height="550px">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <label id="Label5" runat="server" style="font-weight: 500"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
