<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ObserveGame.aspx.cs" Inherits="GTU_Portal.WebForm18" %>
    ...
    <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Observe Event</li>
                </ol>
            </section>
                    ...
                    <section class="col-lg-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Observe Events</h3>
                            ...
                            <div class="box-body">
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered table-condensed" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Ega_id" ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="StudentDataButton" CommandName="StudentData" CssClass="btn btn-primary" BackColor="#ff1a1a" Text="Student Data" runat="server" CommandArgument='<%#Eval("Ega_id") %>'/> 
