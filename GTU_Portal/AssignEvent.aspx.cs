...
//    {
//        DropDownList zonedrp = (DropDownList)gvRow.FindControl("ZoneDropDownList");
//        DropDownList clgdrp = (DropDownList)gvRow.FindControl("CollegeDropDownList");

//        string q1 = @"select C_id, C_name from COLLEGE_MAST where C_zone = '" + zonedrp.SelectedValue + "'";
//        using (SqlConnection conn = new SqlConnection(CS))
//        {
//            conn.Open();
...
//            clgdrp.DataSourceID = null;
//            clgdrp.DataSource = dt1;
//            clgdrp.DataTextField = "C_name";
//            clgdrp.DataValueField = "C_id";
//            clgdrp.DataBind();
//        }
//    }
//}

//protected void EventTypeRadioButtonList_SelectedIndexChanged(object sender, EventArgs e)
//{
//    foreach (GridViewRow gvRow in GridView1.Rows)
//    {
//        DropDownList evnttype = (DropDownList)gvRow.FindControl("DropDownList1");
//        DropDownList zonedrp = (DropDownList)gvRow.FindControl("ZoneDropDownList");
//        if(evnttype.SelectedItem.Text == "Z")
//        {
//            zonedrp.Visible = true;

//        }
//        else
//        {
//            zonedrp.SelectedItem.Text = "6";
//        }
//    }
//}
