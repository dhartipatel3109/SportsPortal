<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="GTU_Portal.Registration" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Gender" runat="server" Font-Bold="true">Gender</asp:Label><br />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="GameDate" runat="server" Font-Bold="true">Game Date</asp:Label><br />
