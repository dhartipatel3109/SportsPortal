...
namespace GTU_Portal
{
    public partial class WebForm18 : System.Web.UI.Page
    {
        ...
        protected void Display()
        {
            ...
            {
                conn.Open();
                string query = @" Select ega.Ega_id, evt.Event_id, egd.Event_type, game.Game_name, evt.Event_Name, z.Zone_Name, egd.Game_date, egd.Gender, clg.C_name
                                    ...
                                    Join ZONE_MAST z on z.Zone_id = ega.Zone_id 
                                    Join COLLEGE_MAST clg on clg.C_id = ega.C_id
                                    where evt.Event_status = 'yes'";
